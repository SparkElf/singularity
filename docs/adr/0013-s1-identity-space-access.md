...
| React深链、状态与切换不接受迟到结果 | component | 真实Router、QueryClient、Zustand，HTTP为外部边界 |
| 退出后历史不恢复且最窄布局与可访问性成立 | browser integration | Vite、Chromium desktop/mobile/320px，HTTP route替身与原始诊断 |
