...
export const AUTH_MFA_FACTORS_PATH = "/api/v1/auth/mfa/factors";
export const AUTH_MFA_VERIFY_PATH = "/api/v1/auth/mfa/verify";
export const AUTH_MFA_CHALLENGE_VERIFY_PATH = "/api/v1/auth/mfa/challenge/verify";
export const AUTH_SAML_CALLBACK_PATH = "/api/v1/auth/saml/callback";
export const AUTH_SAML_START_PATH = "/api/v1/auth/saml/start";
...
export const COLLABORATION_WEBSOCKET_PATH = "/api/v1/collaboration/ws";
...
export const ORGANIZATION_SPACE_GOVERNANCE_POLICY_PATH_TEMPLATE =
  "/api/v1/organizations/{organizationId}/spaces/{spaceId}/governance/policy";
export const DOCUMENT_GOVERNANCE_PATH_TEMPLATE =
  "/api/v1/organizations/{organizationId}/spaces/{spaceId}/notebooks/{notebookId}/documents/{documentId}/governance";
export const DOCUMENT_GOVERNANCE_TRANSITION_PATH_TEMPLATE =
  `${DOCUMENT_GOVERNANCE_PATH_TEMPLATE}/transition`;
export const DOCUMENT_GOVERNANCE_APPROVALS_PATH_TEMPLATE =
  `${DOCUMENT_GOVERNANCE_PATH_TEMPLATE}/approvals`;
export const DOCUMENT_GOVERNANCE_CLASSIFICATION_PATH_TEMPLATE =
  `${DOCUMENT_GOVERNANCE_PATH_TEMPLATE}/classification`;
export const DOCUMENT_GOVERNANCE_LEGAL_HOLD_PATH_TEMPLATE =
  `${DOCUMENT_GOVERNANCE_PATH_TEMPLATE}/legal-hold`;
export const ORGANIZATION_SPACE_GOVERNANCE_TEMPLATES_PATH_TEMPLATE =
  "/api/v1/organizations/{organizationId}/spaces/{spaceId}/governance/templates";
export const ORGANIZATION_SPACE_GOVERNANCE_TEMPLATE_PUBLISH_PATH_TEMPLATE =
  `${ORGANIZATION_SPACE_GOVERNANCE_TEMPLATES_PATH_TEMPLATE}/{templateId}/publish`;
export const ORGANIZATION_SPACE_GOVERNANCE_TEMPLATE_DOCUMENTS_PATH_TEMPLATE =
  `${ORGANIZATION_SPACE_GOVERNANCE_TEMPLATES_PATH_TEMPLATE}/{templateId}/documents`;
export const ORGANIZATION_GOVERNANCE_DASHBOARD_PATH_TEMPLATE =
  "/api/v1/organizations/{organizationId}/governance/dashboard";
export const ORGANIZATION_GOVERNANCE_SEARCH_PATH_TEMPLATE =
  "/api/v1/organizations/{organizationId}/governance/search";
export const ORGANIZATION_PERSONAL_SPACE_PATH_TEMPLATE =
  "/api/v1/organizations/{organizationId}/personal-space";
export const ORGANIZATION_API_KEYS_PATH_TEMPLATE =
  "/api/v1/organizations/{organizationId}/api-keys";
export const ORGANIZATION_SAML_PROVIDERS_PATH_TEMPLATE =
  "/api/v1/organizations/{organizationId}/saml/providers";
export const ORGANIZATION_SAML_PROVIDER_PATH_TEMPLATE =
  `${ORGANIZATION_SAML_PROVIDERS_PATH_TEMPLATE}/{providerId}`;
export const ORGANIZATION_SCIM_TOKENS_PATH_TEMPLATE =
  "/api/v1/organizations/{organizationId}/scim/tokens";
export const ORGANIZATION_SCIM_TOKEN_PATH_TEMPLATE =
...
export const DOCUMENT_EMBEDDED_OBJECTS_PATH_TEMPLATE =
  `${DOCUMENT_GOVERNANCE_PATH_TEMPLATE}/embeds`;
export const DOCUMENT_AI_CHAT_PATH_TEMPLATE =
  `${DOCUMENT_GOVERNANCE_PATH_TEMPLATE}/ai-chat`;
...
export const ORGANIZATION_SPACE_GOVERNANCE_POLICY_CONTROLLER_PATH = toControllerPath(
  ORGANIZATION_SPACE_GOVERNANCE_POLICY_PATH_TEMPLATE,
);
export const DOCUMENT_GOVERNANCE_CONTROLLER_PATH = toControllerPath(
  DOCUMENT_GOVERNANCE_PATH_TEMPLATE,
);
export const DOCUMENT_GOVERNANCE_TRANSITION_CONTROLLER_PATH = toControllerPath(
  DOCUMENT_GOVERNANCE_TRANSITION_PATH_TEMPLATE,
);
export const DOCUMENT_GOVERNANCE_APPROVALS_CONTROLLER_PATH = toControllerPath(
  DOCUMENT_GOVERNANCE_APPROVALS_PATH_TEMPLATE,
);
export const DOCUMENT_GOVERNANCE_CLASSIFICATION_CONTROLLER_PATH = toControllerPath(
  DOCUMENT_GOVERNANCE_CLASSIFICATION_PATH_TEMPLATE,
);
export const DOCUMENT_GOVERNANCE_LEGAL_HOLD_CONTROLLER_PATH = toControllerPath(
  DOCUMENT_GOVERNANCE_LEGAL_HOLD_PATH_TEMPLATE,
);
export const ORGANIZATION_SPACE_GOVERNANCE_TEMPLATES_CONTROLLER_PATH = toControllerPath(
  ORGANIZATION_SPACE_GOVERNANCE_TEMPLATES_PATH_TEMPLATE,
);
export const ORGANIZATION_SPACE_GOVERNANCE_TEMPLATE_PUBLISH_CONTROLLER_PATH = toControllerPath(
  ORGANIZATION_SPACE_GOVERNANCE_TEMPLATE_PUBLISH_PATH_TEMPLATE,
);
export const ORGANIZATION_SPACE_GOVERNANCE_TEMPLATE_DOCUMENTS_CONTROLLER_PATH = toControllerPath(
  ORGANIZATION_SPACE_GOVERNANCE_TEMPLATE_DOCUMENTS_PATH_TEMPLATE,
);
export const ORGANIZATION_GOVERNANCE_DASHBOARD_CONTROLLER_PATH = toControllerPath(
  ORGANIZATION_GOVERNANCE_DASHBOARD_PATH_TEMPLATE,
);
export const ORGANIZATION_GOVERNANCE_SEARCH_CONTROLLER_PATH = toControllerPath(
  ORGANIZATION_GOVERNANCE_SEARCH_PATH_TEMPLATE,
);
export const ORGANIZATION_PERSONAL_SPACE_CONTROLLER_PATH = toControllerPath(
  ORGANIZATION_PERSONAL_SPACE_PATH_TEMPLATE,
);
export const ORGANIZATION_API_KEYS_CONTROLLER_PATH = toControllerPath(
  ORGANIZATION_API_KEYS_PATH_TEMPLATE,
);
export const ORGANIZATION_SAML_PROVIDERS_CONTROLLER_PATH = toControllerPath(
  ORGANIZATION_SAML_PROVIDERS_PATH_TEMPLATE,
);
export const ORGANIZATION_SAML_PROVIDER_CONTROLLER_PATH = toControllerPath(
  ORGANIZATION_SAML_PROVIDER_PATH_TEMPLATE,
);
export const ORGANIZATION_SCIM_TOKENS_CONTROLLER_PATH = toControllerPath(
  ORGANIZATION_SCIM_TOKENS_PATH_TEMPLATE,
);
export const ORGANIZATION_SCIM_TOKEN_CONTROLLER_PATH = toControllerPath(
...
export const DOCUMENT_EMBEDDED_OBJECTS_CONTROLLER_PATH = toControllerPath(
  DOCUMENT_EMBEDDED_OBJECTS_PATH_TEMPLATE,
);
export const DOCUMENT_AI_CHAT_CONTROLLER_PATH = toControllerPath(
