...
const DOCUMENTED_ROUTE_INVENTORY: readonly RouteInventoryEntry[] = [
  ...
  { methods: ["get", "post"], path: AUTH_MFA_FACTORS_PATH },
  { methods: ["post"], path: AUTH_MFA_VERIFY_PATH },
  { methods: ["post"], path: AUTH_MFA_CHALLENGE_VERIFY_PATH },
  { methods: ["get"], path: AUTH_SAML_START_PATH },
  { methods: ["post"], path: AUTH_SAML_CALLBACK_PATH },
  { methods: ["get"], path: AUTHORIZED_SPACES_PATH },
  { methods: ["get"], path: ENTERPRISE_MANAGEMENT_ACCESS_PATH },
  ...
  { methods: ["post"], path: ORGANIZATION_SPACE_DISCOVERY_SEARCH_PATH_TEMPLATE },
  { methods: ["post"], path: ORGANIZATION_SPACE_DISCOVERY_GRAPH_PATH_TEMPLATE },
  ...
  { methods: ["get"], path: ORGANIZATION_SPACE_RESTORES_PATH_TEMPLATE },
  {
    methods: ["post"],
    path: ORGANIZATION_SPACE_RESTORE_ACTIVATION_PATH_TEMPLATE,
  },
  { methods: ["get"], path: ORGANIZATION_SPACE_OBSERVABILITY_PATH_TEMPLATE },
  { methods: ["get", "patch"], path: DOCUMENT_ACCESS_POLICY_PATH_TEMPLATE },
  { methods: ["get", "patch"], path: DOCUMENT_COLLABORATION_FEATURE_PATH_TEMPLATE },
  { methods: ["get", "post"], path: DOCUMENT_COMMENT_THREADS_PATH_TEMPLATE },
  { methods: ["get"], path: DOCUMENT_COMMENT_MENTION_CANDIDATES_PATH_TEMPLATE },
  { methods: ["get"], path: DOCUMENT_COMMENT_THREAD_PATH_TEMPLATE },
  { methods: ["post"], path: DOCUMENT_COMMENT_ENTRIES_PATH_TEMPLATE },
  { methods: ["delete", "patch"], path: DOCUMENT_COMMENT_ENTRY_PATH_TEMPLATE },
  { methods: ["patch"], path: DOCUMENT_COMMENT_THREAD_STATUS_PATH_TEMPLATE },
  { methods: ["get"], path: DOCUMENT_HISTORY_PATH_TEMPLATE },
  { methods: ["get"], path: DOCUMENT_HISTORY_DIFF_PATH_TEMPLATE },
  { methods: ["post"], path: DOCUMENT_HISTORY_RESTORE_PATH_TEMPLATE },
  { methods: ["get"], path: NOTIFICATIONS_PATH },
  { methods: ["get"], path: NOTIFICATION_UNREAD_COUNT_PATH },
  { methods: ["patch"], path: NOTIFICATION_READ_PATH_TEMPLATE },
  { methods: ["post"], path: NOTIFICATIONS_READ_ALL_PATH },
  ...
  { methods: ["get", "put"], path: ORGANIZATION_SPACE_GOVERNANCE_POLICY_PATH_TEMPLATE },
  { methods: ["get"], path: DOCUMENT_GOVERNANCE_PATH_TEMPLATE },
  { methods: ["post"], path: DOCUMENT_GOVERNANCE_TRANSITION_PATH_TEMPLATE },
  { methods: ["get"], path: DOCUMENT_GOVERNANCE_APPROVALS_PATH_TEMPLATE },
  { methods: ["put"], path: DOCUMENT_GOVERNANCE_CLASSIFICATION_PATH_TEMPLATE },
  { methods: ["put"], path: DOCUMENT_GOVERNANCE_LEGAL_HOLD_PATH_TEMPLATE },
  { methods: ["get", "post"], path: ORGANIZATION_SPACE_GOVERNANCE_TEMPLATES_PATH_TEMPLATE },
  { methods: ["post"], path: ORGANIZATION_SPACE_GOVERNANCE_TEMPLATE_PUBLISH_PATH_TEMPLATE },
  { methods: ["post"], path: ORGANIZATION_SPACE_GOVERNANCE_TEMPLATE_DOCUMENTS_PATH_TEMPLATE },
  { methods: ["get"], path: ORGANIZATION_GOVERNANCE_DASHBOARD_PATH_TEMPLATE },
  { methods: ["post"], path: ORGANIZATION_GOVERNANCE_SEARCH_PATH_TEMPLATE },
  { methods: ["post"], path: ORGANIZATION_PERSONAL_SPACE_PATH_TEMPLATE },
  { methods: ["get", "post"], path: ORGANIZATION_API_KEYS_PATH_TEMPLATE },
  { methods: ["delete"], path: ORGANIZATION_API_KEY_PATH_TEMPLATE },
  { methods: ["get", "post"], path: ORGANIZATION_SAML_PROVIDERS_PATH_TEMPLATE },
  { methods: ["patch"], path: ORGANIZATION_SAML_PROVIDER_PATH_TEMPLATE },
...
const AUTHENTICATED_OPERATIONS: readonly OperationReference[] = [
  ...
  [ENTERPRISE_MANAGEMENT_ACCESS_PATH, "get"],
  ...
  [ORGANIZATION_SPACE_RESTORES_PATH_TEMPLATE, "get"],
  [ORGANIZATION_SPACE_OBSERVABILITY_PATH_TEMPLATE, "get"],
  [DOCUMENT_ACCESS_POLICY_PATH_TEMPLATE, "get"],
  [DOCUMENT_COLLABORATION_FEATURE_PATH_TEMPLATE, "get"],
  [DOCUMENT_COMMENT_THREADS_PATH_TEMPLATE, "get"],
  [DOCUMENT_COMMENT_MENTION_CANDIDATES_PATH_TEMPLATE, "get"],
  [DOCUMENT_COMMENT_THREAD_PATH_TEMPLATE, "get"],
  [DOCUMENT_HISTORY_PATH_TEMPLATE, "get"],
  [NOTIFICATIONS_PATH, "get"],
  [NOTIFICATION_UNREAD_COUNT_PATH, "get"],
  [ORGANIZATION_SPACE_GOVERNANCE_POLICY_PATH_TEMPLATE, "get"],
  [DOCUMENT_GOVERNANCE_PATH_TEMPLATE, "get"],
  [DOCUMENT_GOVERNANCE_APPROVALS_PATH_TEMPLATE, "get"],
  [ORGANIZATION_SPACE_GOVERNANCE_TEMPLATES_PATH_TEMPLATE, "get"],
  [ORGANIZATION_GOVERNANCE_DASHBOARD_PATH_TEMPLATE, "get"],
  [ORGANIZATION_GOVERNANCE_SEARCH_PATH_TEMPLATE, "post"],
  [DOCUMENT_EMBEDDED_OBJECTS_PATH_TEMPLATE, "get"],
];

const MUTATION_OPERATIONS: readonly OperationReference[] = [
  [AUTH_INVITATION_ACCEPT_PATH, "post"],
  [AUTH_LOGOUT_PATH, "post"],
  [ORGANIZATION_SPACE_DISCOVERY_SEARCH_PATH_TEMPLATE, "post"],
  [ORGANIZATION_SPACE_DISCOVERY_GRAPH_PATH_TEMPLATE, "post"],
  ...
  [DOCUMENT_ACCESS_POLICY_PATH_TEMPLATE, "patch"],
  [DOCUMENT_COLLABORATION_FEATURE_PATH_TEMPLATE, "patch"],
  [DOCUMENT_COMMENT_THREADS_PATH_TEMPLATE, "post"],
  [DOCUMENT_COMMENT_ENTRIES_PATH_TEMPLATE, "post"],
  [DOCUMENT_COMMENT_ENTRY_PATH_TEMPLATE, "patch"],
  [DOCUMENT_COMMENT_ENTRY_PATH_TEMPLATE, "delete"],
  [DOCUMENT_COMMENT_THREAD_STATUS_PATH_TEMPLATE, "patch"],
  [DOCUMENT_HISTORY_RESTORE_PATH_TEMPLATE, "post"],
  [NOTIFICATION_READ_PATH_TEMPLATE, "patch"],
  [NOTIFICATIONS_READ_ALL_PATH, "post"],
  [AUTH_MFA_FACTORS_PATH, "post"],
  [AUTH_MFA_VERIFY_PATH, "post"],
  [ORGANIZATION_SPACE_GOVERNANCE_POLICY_PATH_TEMPLATE, "put"],
  [DOCUMENT_GOVERNANCE_TRANSITION_PATH_TEMPLATE, "post"],
  [DOCUMENT_GOVERNANCE_CLASSIFICATION_PATH_TEMPLATE, "put"],
  [DOCUMENT_GOVERNANCE_LEGAL_HOLD_PATH_TEMPLATE, "put"],
  [ORGANIZATION_SPACE_GOVERNANCE_TEMPLATES_PATH_TEMPLATE, "post"],
  [ORGANIZATION_SPACE_GOVERNANCE_TEMPLATE_PUBLISH_PATH_TEMPLATE, "post"],
  [ORGANIZATION_PERSONAL_SPACE_PATH_TEMPLATE, "post"],
  [ORGANIZATION_API_KEYS_PATH_TEMPLATE, "post"],
  [ORGANIZATION_API_KEY_PATH_TEMPLATE, "delete"],
  [ORGANIZATION_SAML_PROVIDERS_PATH_TEMPLATE, "post"],
  [ORGANIZATION_SAML_PROVIDER_PATH_TEMPLATE, "patch"],
  [ORGANIZATION_SCIM_TOKENS_PATH_TEMPLATE, "post"],
  [ORGANIZATION_SCIM_TOKEN_PATH_TEMPLATE, "delete"],
  [DOCUMENT_EMBEDDED_OBJECTS_PATH_TEMPLATE, "put"],
  [DOCUMENT_AI_CHAT_PATH_TEMPLATE, "post"],
];
...
describe("generated OpenAPI HTTP contract", () => {
  ...
  test("declares Origin and CSRF headers for every browser mutation", () => {
    ...
    // SAML ACS 是外部 IdP 的 form POST，不应要求 Origin 或 Cookie/CSRF。
    const samlCallback = operation(document, AUTH_SAML_CALLBACK_PATH, "post");
    expect(samlCallback.security).toBeUndefined();
    expect(samlCallback.parameters ?? []).not.toContainEqual(
