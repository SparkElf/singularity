...
const actionLabels: Record<AuditAction, string> = {
  ...
  "comment.reopen": "重新打开评论",
  "comment.delete": "删除评论",
  "collaboration.join": "加入实时协作",
  "collaboration.operation": "提交协作操作",
  "collaboration.conflict": "协作冲突",
  "collaboration.resume": "恢复协作会话",
  "collaboration.revoke": "撤销协作会话",
  "history.view": "查看历史",
