...
> An enterprise knowledge base in active development, built from the SiYuan codebase.
...
The project is evolving the SiYuan foundation toward a cloud-hosted enterprise knowledge base with organization, sharing, permission, and collaboration capabilities. These are project goals, not a claim that every capability is already implemented.

Current work focuses on a maintainable independent fork, clear upstream integration, a coherent design system, and the identity and space foundations required by later enterprise features.
